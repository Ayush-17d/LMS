...
//       {/* Hero Section */}
//       <section className="relative bg-[#FAF9F6] dark:bg-[#383838] py-24 md:py-36 overflow-hidden border-b border-gray-200 dark:border-gray-700">
...
//             <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 leading-tight text-gray-900 dark:text-white">
//               About <span className="text-blue-600 dark:text-blue-400">LearnifyHub</span>
//             </motion.h1>
//             <motion.p variants={fadeInUp} className="text-lg sm:text-xl md:text-2xl max-w-3xl mx-auto mb-8 text-gray-700 dark:text-gray-300">
...
//               className="space-y-6"
//             >
//               <motion.p variants={fadeInRight} className="text-gray-700 dark:text-gray-300 text-lg">
...
//                 <a href="/mission" className="text-blue-600 dark:text-blue-400 font-medium inline-flex items-center hover:underline">
...
//       {/* Core Values Section */}
//       <section className="bg-white dark:bg-[#2D2D2D] py-20 md:py-28">
//         <div className="container mx-auto px-4 md:px-6">
//           <motion.div
//             initial="hidden"
//             whileInView="visible"
...
//                 key={index}
//                 variants={fadeInUp}
//                 className="bg-[#FAF9F6] dark:bg-[#2A2A2A] p-8 rounded-lg shadow-lg hover:shadow-xl transition duration-300 border border-gray-100 dark:border-gray-700 group hover:border-blue-200 dark:hover:border-blue-700"
//               >
...
//       {/* Milestones Section */}
//       <section className="py-20 md:py-28 bg-[#FAF9F6] dark:bg-[#383838]">
//         <div className="container mx-auto px-4 md:px-6">
//           <motion.div
//             initial="hidden"
//             whileInView="visible"
...
//             className="text-center mb-16"
//           >
//             <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">Our Milestones</h2>
//             <div className="w-20 h-1 bg-blue-600 dark:bg-blue-400 mx-auto mb-6"></div>
//           </motion.div>
...
//                 {[
//                   { year: "2023", event: "LearnifyHub Founded", icon: <TbFlag className="w-8 h-8" /> },
//                   { year: "2024", event: "Launched 100+ Courses", icon: <FiBookOpen className="w-8 h-8" /> },
//                   { year: "2025", event: "Reached 10K Students", icon: <PiStudentDuotone className="w-8 h-8" /> },
//                 ].map((milestone, index) => (
//                   <motion.div 
//                     key={index}
//                     initial="hidden"
...
//                   >
//                     <div className={`flex flex-col ${index % 2 === 0 ? 'items-center' : 'items-center'}`}>
//                       <div className="w-16 h-16 rounded-full bg-blue-600 dark:bg-blue-500 flex items-center justify-center z-10 mb-4 shadow-lg">
//                         <div className="text-white">{milestone.icon}</div>
//                       </div>
//                       <div className={`text-center ${index % 2 === 0 ? 'mt-0' : 'mt-0'}`}>
//                         <div className="bg-white dark:bg-[#2D2D2D] p-6 rounded-lg shadow-lg border border-gray-100 dark:border-gray-700 hover:border-blue-200 dark:hover:border-blue-700 transition-all duration-300 hover:shadow-xl">
//                           <h3 className="text-2xl font-bold text-blue-600 dark:text-blue-400 mb-2">{milestone.year}</h3>
//                           <p className="text-gray-700 dark:text-gray-300 font-medium">{milestone.event}</p>
//                         </div>
//                       </div>
//                     </div>
//                   </motion.div>
...
//                 {[
//                   { year: "2023", event: "LearnifyHub Founded", icon: <TbFlag className="w-5 h-5" /> },
//                   { year: "2024", event: "Launched 100+ Courses", icon: <FiBookOpen className="w-5 h-5" /> },
//                   { year: "2025", event: "Reached 10K Students", icon: <PiStudentDuotone  className="w-5 h-5" /> },
//                 ].map((milestone, index) => (
//                   <motion.div 
//                     key={index}
//                     initial="hidden" 
...
//                   >
//                     <div className="w-10 h-10 rounded-full bg-blue-600 dark:bg-blue-500 flex items-center justify-center z-10 mt-1 mr-6 shadow-md">
//                       <div className="text-white">{milestone.icon}</div>
//                     </div>
//                     <div className="flex-1">
//                       <div className="bg-white dark:bg-[#2D2D2D] p-4 rounded-lg shadow-md border border-gray-100 dark:border-gray-700">
//                         <h3 className="text-xl font-bold text-blue-600 dark:text-blue-400 mb-1">{milestone.year}</h3>
...
//       {/* Call to Action */}
//       <section className="bg-[#2D2D2D] dark:bg-[#1A1A1A] text-white py-20">
...
//               <a href="/signup" className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-8 rounded-md shadow-md transition duration-300">
//                 Join LearnifyHub
//               </a>
//               <a href="/teachers" className="bg-transparent hover:bg-white/10 text-white border border-white font-medium py-3 px-8 rounded-md shadow-md transition duration-300">
//                 Become a Teacher
//               </a>
//             </motion.div>
//           </motion.div>
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] dark:bg-[#383838] text-gray-800 dark:text-gray-200">
      ...
      <section className="relative bg-[#FAF9F6] dark:bg-[#383838] py-16 md:py-24 overflow-hidden border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <motion.div initial="hidden" animate="visible" variants={staggerChildren} className="text-center">
            <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 leading-tight text-gray-900 dark:text-white">
              About <span className="text-blue-600 dark:text-blue-400">LearnifyHub</span>
            </motion.h1>
            <motion.p variants={fadeInUp} className="text-lg sm:text-xl md:text-2xl max-w-3xl mx-auto mb-6 text-gray-700 dark:text-gray-300">
              Transforming education by connecting teachers and learners through innovative technology.
            </motion.p>
            <motion.a
              href="/courses"
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-3">Our Story</h2>
      ...
      <section className="bg-white dark:bg-[#2D2D2D] py-12 md:py-16">
        <div className="container mx-auto px-4 md:px-6">
          <motion.div
            ...
            className="text-center mb-10"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-3">Our Core Values</h2>
            <div className="w-20 h-1 bg-blue-600 dark:bg-blue-400 mx-auto mb-4"></div>
          </motion.div>
          <motion.div
            initial="hidden"
          ...
          >
            {[
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2 text-center">{value.title}</h3>
                <p className="text-gray-600 dark:text-gray-400 text-center">{value.desc}</p>
              </motion.div>
            ))}
          </motion.div>
      ...
      <section className="py-12 md:py-16 bg-[#FAF9F6] dark:bg-[#383838]">
        <div className="container mx-auto px-4 md:px-6">
          <motion.div
            ...
            className="text-center mb-10"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-3">Our Milestones</h2>
            <div className="w-20 h-1 bg-blue-600 dark:bg-blue-400 mx-auto mb-4"></div>
          </motion.div>
                    ...
                    <div className={`flex flex-col ${index % 2 === 0 ? 'items-center' : 'items-center'}`}>
                      ...
                      <div className={`text-center ${index % 2 === 0 ? 'mt-0' : 'mt-0'}`}>
                        <div className="bg-white dark:bg-[#2D2D2D] p-5 rounded-lg shadow-lg border border-gray-100 dark:border-gray-700 hover:border-blue-200 dark:hover:border-blue-700 transition-all duration-300 hover:shadow-xl">
                          <h3 className="text-2xl font-bold text-blue-600 dark:text-blue-400 mb-1">{milestone.year}</h3>
                          <p className="text-gray-700 dark:text-gray-300 font-medium">{milestone.event}</p>
                        </div>
                      </div>
                    </div>
